...
/*********************************************************************************************/
	...
	function matakuliah_add(){
		...
		$data['page_title'] = 'Tambah Data Mata Kuliah';	
	...
	function matakuliah_search(){
		...
		$data['page_title'] = 'Cari Mata Kuliah';
		$data['page_name'] = 'matakuliah';	
		$data['search_query'] = $search_query;
		$data['start_number'] = 0;
...
/**************************************************************************/
	...
	function pengampu_add(){
		...
		$data['page_title'] = 'Tambah Data Pengampu';
	...
	function pengampu_edit($kode){
		...
		$data['page_title'] = 'Edit Data Pengampu';
...
/***************************************************************************/	
	...
	function penjadwalan(){
		...
		if(!empty($_POST)){
			...
			if($this->form_validation->run() == TRUE)
			{				
				//Tempat keajaiban dimulai. SEMANGAAAAAATTTTT
	...
	function excel_report(){
        ...
        header('Content-Disposition: attachment;filename="Jadwal_Kuliah_Update_Tanggal_'.date('dMy').'.xls"');
